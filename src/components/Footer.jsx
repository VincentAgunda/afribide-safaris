...
import CookieConsent from "./CookieConsent"; // ✅ import modal

function Footer() {
  const currentYear = new Date().getFullYear();
  const [openCookies, setOpenCookies] = useState(false); // ✅ state
            ...
            <div>
              ...
              <ul className="space-y-5 text-[15px] text-white/60 font-light">
                ...
                <li className="flex items-center gap-4 group">
                  ...
                  <a href="tel:+254113073535" className="group-hover:text-white transition-colors duration-300">
                    +254 113 073 535
                  </a>
                </li>
                <li className="flex items-center gap-4 group">
